...
public class ScorchedgrassBlock extends RagnorokTaleOfTheVikingsModElements.ModElement {
	@ObjectHolder("ragnorok_tale_of_the_vikings:scorchedgrass")
	public static final Block block = null;
	public ScorchedgrassBlock(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 29);
	}
