...
public class NifilhiniumBlock extends RagnorokTaleOfTheVikingsModElements.ModElement {
	@ObjectHolder("ragnorok_tale_of_the_vikings:nifilhinium")
	public static final Block block = null;
	public NifilhiniumBlock(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1f, 11f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("nifilhinium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragnorok_tale_of_the_vikings:nifilhinium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("nifilhinium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragnorok_tale_of_the_vikings:nifilhinium"),
					configuredFeature);
		}
	}
	@SubscribeEvent
