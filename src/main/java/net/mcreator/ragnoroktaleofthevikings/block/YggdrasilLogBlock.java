...
import net.mcreator.ragnoroktaleofthevikings.itemgroup.YggdrasilItemGroup;
...
public class YggdrasilLogBlock extends RagnorokTaleOfTheVikingsModElements.ModElement {
	@ObjectHolder("ragnorok_tale_of_the_vikings:yggdrasil_log")
	public static final Block block = null;
	public YggdrasilLogBlock(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 20);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(YggdrasilItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The only mortal item to bind the nine realms"));
		}
