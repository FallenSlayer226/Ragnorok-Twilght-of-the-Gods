...
public class MoltenMuspelhiniumBlock extends RagnorokTaleOfTheVikingsModElements.ModElement {
	@ObjectHolder("ragnorok_tale_of_the_vikings:molten_muspelhinium")
	public static final Block block = null;
	public MoltenMuspelhiniumBlock(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 34);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("molten_muspelhinium");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("ragnorok_tale_of_the_vikings:molten_muspelhinium_match"),
			...
			event.getRegistry().register(feature.setRegistryName("molten_muspelhinium"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ragnorok_tale_of_the_vikings:molten_muspelhinium"),
					configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("ragnorok_tale_of_the_vikings:yggdrasil_biome").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("ragnorok_tale_of_the_vikings:nifilheim_biome").equals(event.getName()))
			biomeCriteria = true;
