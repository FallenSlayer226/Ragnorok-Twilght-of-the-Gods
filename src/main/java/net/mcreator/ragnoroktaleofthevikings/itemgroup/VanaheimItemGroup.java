...
public class VanaheimItemGroup extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public VanaheimItemGroup(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 18);
	}

	@Override
	public void initElements() {
		tab = new ItemGroup("tabvanaheim") {
			@OnlyIn(Dist.CLIENT)
			@Override
