...
public class HelItemGroup extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public HelItemGroup(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 14);
	}

	@Override
	public void initElements() {
		tab = new ItemGroup("tabhel") {
			@OnlyIn(Dist.CLIENT)
			@Override
