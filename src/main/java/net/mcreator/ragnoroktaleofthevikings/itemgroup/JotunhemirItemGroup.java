...
public class JotunhemirItemGroup extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public JotunhemirItemGroup(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 15);
	}

	@Override
	public void initElements() {
		tab = new ItemGroup("tabjotunhemir") {
			@OnlyIn(Dist.CLIENT)
			@Override
