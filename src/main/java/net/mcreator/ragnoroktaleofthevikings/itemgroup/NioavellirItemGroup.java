...
public class NioavellirItemGroup extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public NioavellirItemGroup(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 17);
	}

	@Override
	public void initElements() {
		tab = new ItemGroup("tabnioavellir") {
			@OnlyIn(Dist.CLIENT)
			@Override
