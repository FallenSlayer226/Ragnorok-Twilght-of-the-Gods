...
package net.mcreator.ragnoroktaleofthevikings.world.biome;
...
import net.mcreator.ragnoroktaleofthevikings.block.ChilledGrassBlock;
...
public class NifilheimBiomeBiome extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public static Biome biome;
	public NifilheimBiomeBiome(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 23);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ChilledGrassBlock.block.getDefaultState(),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(1f).scale(1.2000000000000002f)
						.temperature(0f).downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("ragnorok_tale_of_the_vikings:nifilheim_biome"));
			}
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		...
		BiomeManager.addBiome(BiomeManager.BiomeType.ICY,
				new BiomeManager.BiomeEntry(RegistryKey.getOrCreateKey(Registry.BIOME_KEY, WorldGenRegistries.BIOME.getKey(biome)), 64));
	}
}
