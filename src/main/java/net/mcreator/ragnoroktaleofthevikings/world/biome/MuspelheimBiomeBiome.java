...
import net.mcreator.ragnoroktaleofthevikings.block.ScorchedgrassBlock;
...
public class MuspelheimBiomeBiome extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public static Biome biome;
	public MuspelheimBiomeBiome(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 33);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ScorchedgrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("ragnorok_tale_of_the_vikings:muspelheim_biome"));
			}
		}
	}
	@Override
