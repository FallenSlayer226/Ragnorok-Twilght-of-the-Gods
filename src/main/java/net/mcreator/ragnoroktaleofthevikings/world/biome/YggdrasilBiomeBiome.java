...
public class YggdrasilBiomeBiome extends RagnorokTaleOfTheVikingsModElements.ModElement {
	public static Biome biome;
	public YggdrasilBiomeBiome(RagnorokTaleOfTheVikingsModElements instance) {
		super(instance, 21);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ragnorok_tale_of_the_vikings:yggdrasil_biome"));
			}
		}
	}
	@Override
